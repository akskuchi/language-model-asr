...
In all three models we get worse results when implementing Xavier initialization. The perplexity is not modified by much but METEOR, ROUGE and Naive Accuracy are clearly worse. Analysis of the activation function values across training steps would be needed to determine why Xavier initialization wasn't able to improve the results.
