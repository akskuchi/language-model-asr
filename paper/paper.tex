...
\begin{figure}[h]
\includegraphics{sr-eda-wikitext-train-words}
\includegraphics{sr-eda-wikitext-valid-words}
\centering
...
\begin{figure}[h]
\includegraphics{sr-eda-wikitext-bigrams}
\includegraphics{sr-eda-wikitext-trigrams}
\centering
...
The second dataset we used was Gigaword. This dataset is based on ____,
containing 110,382,986 tokens in the training set, 549,0454 tokens in the
validation set and ____ tokens in the test set. The combined dictionary
contains ____ unique tokens.
...
\begin{figure}[h]
\includegraphics{sr-eda-gigaword-train-words}
\includegraphics{sr-eda-gigaword-valid-words}
\centering
...
\begin{figure}[h]
\includegraphics{sr-eda-gigaword-bigrams}
\includegraphics{sr-eda-gigaword-trigrams}
\centering
...
\section{Performance by Model Architecture}
\label{sec:perf_by_model_arch}

\begin{figure}[h]
\includegraphics{sr-perf-by-model-architecture}
\centering
...
\section{Performance by number of hidden layers}
\label{sec:perf_by_n_layers}

\begin{figure}[h]
\includegraphics{sr-perf-by-hidden-lstm}
\includegraphics{sr-perf-by-hidden-gru}
\includegraphics{sr-perf-by-hidden-rnn}
\centering
...
\section{Performance by number of hidden units}
\label{sec:perf_by_n_hidden}

\begin{figure}[h]
\includegraphics{sr-perf-by-hidden-units-lstm}
\includegraphics{sr-perf-by-hidden-units-gru}
\includegraphics{sr-perf-by-hidden-units-rnn}
\centering
...
\section{Performance by Dropout}
\label{sec:perf_by_dropout}

\begin{figure}[h]
\includegraphics{sr-perf-by-dropout-lstm}
\includegraphics{sr-perf-by-dropout-gru}
\includegraphics{sr-perf-by-dropout-rnn}
\centering
...
\section{Performance by Embedding Dimensions}
\label{sec:perf_by_embedding}

\begin{figure}[h]
\includegraphics{sr-perf-by-embedding-lstm}
\includegraphics{sr-perf-by-embedding-gru}
\includegraphics{sr-perf-by-embedding-rnn}
\centering
...
\section{Performance by Shortlist Dimension}
\label{sec:perf_by_shortlist}

\begin{figure}[h]
\includegraphics{sr-perf-by-shortlist-lstm}
\includegraphics{sr-perf-by-shortlist-gru}
\includegraphics{sr-perf-by-shortlist-rnn}
\centering
...
\begin{figure}[h]
\includegraphics{sr-perf-by-model-tied-weights}
\centering
...
\begin{figure}[h]
\includegraphics{sr-perf-by-model-xavier-init}
\centering
\caption{Validation Set Performance by Model on WikiText for Xavier Initialization}
\end{figure}

\section{Kaiming Initialization}
\label{sec:perf_by_kaiming_init}

\begin{figure}[h]
\includegraphics{sr-perf-by-model-kaiming-init}
\centering
\caption{Validation Set Performance by Model on WikiText for Xavier Initialization}
\end{figure}
