...
\includegraphics[width=0.7\columnwidth][width=\textwidth]{01}
...
\begin{figure}[ht]
\includegraphics[width=0.7\columnwidth]{sr-perf-by-model-tied-weights}
\centering
...
\begin{figure}[ht]
\includegraphics[width=0.7\columnwidth]{sr-perf-by-model-xavier-init}
\centering
...
\begin{figure}[ht]
\includegraphics[width=0.7\columnwidth]{sr-perf-by-model-kaiming-init}
\centering
\caption{Validation Set Performance by Model on WikiText for Xavier Initialization}
\end{figure}
